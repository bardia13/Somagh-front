...
@Component({
  selector: 'ngx-issue-button-component',
  templateUrl: './issue-button-component.component.html',
  styleUrls: ['./issue-button-component.component.scss']
})
export class IssueButtonComponentComponent implements ViewCell, OnInit {
  renderValue: string;
